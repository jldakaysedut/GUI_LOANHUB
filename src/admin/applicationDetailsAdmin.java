...
public class applicationDetailsAdmin extends javax.swing.JFrame {

  
    public applicationDetailsAdmin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("APPLICATION DETAILS(Admin)");
        jLabel1.setToolTipText("");
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 440, 40));
        ...
        jPanel4.add(afname, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 220, 210, -1));
        jPanel4.add(acontact, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 320, 210, -1));
        ...
        jPanel4.add(alname, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 270, 210, -1));
   ...
   if (aid.getText().isEmpty()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(applicationDetailsAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new applicationDetailsAdmin().setVisible(true);
            }
        });
    }
